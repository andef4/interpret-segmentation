...
def generate_image(path):
    ...
    def c(): return cross(draw, 40 + random.randint(0, 20), 20 + random.randint(0, 20), random.randint(100, 255))
    def t(): return triangle(draw, 20 + random.randint(0, 20), 110 + random.randint(0, 20), random.randint(100, 255))
