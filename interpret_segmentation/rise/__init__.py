# source: https://github.com/eclique/RISE/blob/fac5d54225977091dc18cc71ef8e07f726c3bc20/explanations.py
...
"""
    def forward(self, x):
        ...
        for i in range(0, mask_count, self.gpu_batch):
            p.append(self.model(stack[i:min(i + self.gpu_batch, mask_count)]))
        p = torch.cat(p)
